...
def test_sanitizer_keeps_bracket_citations_for_search_mode() -> None:
    text = "Ответ [1][2]"
    sanitized, meta = sanitize_llm_text(text, sources_requested=False, allow_source_citations=True)
