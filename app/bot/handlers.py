...
async def send_result(
    ...
    *,
    ...
    is_search_intent = public_result.intent.startswith("command.search") or public_result.intent.startswith("menu.search")
    should_apply_strict = not facts_enabled and not is_search_intent and public_result.intent in {"ask", "command.ask", "question", "text"}
    if should_apply_strict:
